...
if(gamestate === PLAY){
    ...
    zombie1.x = player.x-200;
    zombie1.y = player.y+350
    zombie2.y = player.y+210;
    zombie2.x = player.x+100
    zombie3.x = player.x-60;
    zombie4.x = player.x-50;
    zombie4.y = player.y+50;
    zombie5.y = player.y+150;
...
if(energy1.x == 1180||energy1.x == 580||energy1.y == 280 || energy1.y === 580){
    energy1.destroy();
}
